...
|:---:|---|---|:---:|
| 0 | 工作人員綠色通道 | 提供社團工作人員免密碼快速蓋章 | |
| 1 | 環保杯與餐具 | 使用環保杯或環保餐具購買飲料或餐點一次 | |
| 2 | 看靜態展+許願樹 | 看靜態展+許願樹（現場驗證） | |
| 3 | IG 分享靜態展 | 在 IG 限動分享靜態展並標註社團 | |
| 4 | 運動會擺攤 | 參加 11/11 運動會擺攤（現場驗證） | |
| 5 | 吃一餐蔬食餐 | 吃一餐蔬食餐（核心任務） | |
| 6 | IG 分享料理實作 | 在 IG 限動分享料理實作並標註社團 | |
| 7 | 帶好友同行 | 帶一位朋友參加蔬食月活動（兩人皆可蓋） | |
| 8 | 料理實作 | 參加 11/18 料理實作（現場驗證） | |
| 9 | 主題社課（擇一） | 參加前行社課或總結社課（現場驗證） | |
